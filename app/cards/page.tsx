...
const CardsPage = () => {
  return (
    ...
    <div
      key={card.id} // ✅ add key here
      className="relative cursor-pointer bg-gradient-to-br from-indigo-600 to-purple-600 text-white rounded-xl shadow-lg p-6 h-56 w-full flex flex-col justify-between hover:scale-105 transition-transform"
    >
